                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content py-3">
                                            ...
                                            <div class="card-body p-4">
                                                ...
                                                <form class="row g-3" action="{{route('update.room', $editData->id)}}" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <input type="text" name="roomtype_id" class="form-control" id="input1" value="{{ $editData['Roomtype']['name'] }}" >
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                       ...
                                                       @foreach ( $multiImgs as $item )
											            ...
											            <img src="{{(!empty($item->multi_img)) ? url('upload/roomImg/multiImg/'. $item->multi_img) : url('upload/no_image.jpg')}}" alt="Admin"  width="60" height="60">                                                    
                                                       <a href="{{route('multi.image.delete', $item->id)}}"><i class="lni lni-close"></i></a>
                                                       @endforeach

                                                        <div class="row" width="60" id="preview_img"></div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <textarea name="short_desc" class="form-control" id="input11" placeholder="Short Description">{{$editData->short_desc}}</textarea>
                                                    </div>

                                                     <div class="col-md-12">
                                                        <label for="input11" class="form-label"> Description</label>
                                                        <textarea name="description" class="form-control" id="input11" placeholder="Description" style="height: 180px;"> {{$editData->description}}</textarea>
                                                    </div>
                                                        ...
                                                        <option value="Electronic door lock"  {{$item->facility_name == 'Electronic door lock'?'selected':''}}>Electronic door lock</option> 
                                                                 ...
                                                                 <div class="col-md-4">
                                                                    <div class="form-group" style="padding-top: 30px;">
                                                                          <a class="btn btn-success addeventmore"><i class="lni lni-circle-plus"></i></i></a>
                                                                          <span class="btn btn-danger btn-sm removeeventmore"><i class="lni lni-circle-minus"></i></i></span>
                                                                    </div>
                                                                 </div>
                                                              </div>
                                                           </div>
                                ...
                                <div class="tab-pane fade" id="primaryprofile" role="tabpanel">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <a class="card-title btn btn-primary float-right" onclick="addRoomNumber()" id="adadRoomNumber" >
                                                <i class="lni lni-plus">Add New</i>
                                            </a>
                                            <div class="roomNumberHide" id="roomNumberHide" >

                                                <form action="{{route('store.roomNumber' ,$editData->id)}}" method="post">
                                                    @csrf
...
<td>
                                        ...
                                        <a href=" {{route('edit.roomNumber', $item->id)}}" class="btn btn-warning px-3 radius-30"> Edit</a>
                                        <a href=" {{route('delete.roomNumber', $item->id)}}" class="btn btn-danger px-3 radius-30" id="delete"> Delete</a>  
                                                        </td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
                                ...
                                {{-- //tab pane room numbers ahhhhhhh ka lami matug oiioiiiooiio --}}
                            </div>
                        </div>
                    </div>
